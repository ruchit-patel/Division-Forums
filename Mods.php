                ...
                <div class="col-md-7 col-md-offset-1">
                    <div class="card" style="min-height:250px;">
                        <div class="card-block">
							...
							Description: Sends out a recon pulse that marks hostiles and allies through walls and covers.
							All mods require Medical Wing Upgrade - Quarantine
							</font>
                        </div>
                    </div>
                </div>
...
<div class="wrapper">
	<div class="row"> <!--row for fitting three cards for mods-->
		...
		<div class="col-md-4"> <!--fitting third mod card-->
	...
	</div> <!--closing row for three card mods-->
</div> <!--closing wrapper class for three card mods-->
...
<div class="wrapper">
	<div class="row"> <!--master mod row begins-->
